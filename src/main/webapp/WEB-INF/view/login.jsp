...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {background:url(${pageContext.request.contextPath}/static/images/icon-login.png) no-repeat 1px 0;}
        .login-main .login-bottom .center .item .icon-2 {background:url(${pageContext.request.contextPath}/static/images/icon-login.png) no-repeat -54px 0;}
        .login-main .login-bottom .center .item .icon-3 {background:url(${pageContext.request.contextPath}/static/images/icon-login.png) no-repeat -106px 0;}
        .login-main .login-bottom .center .item .icon-4 {background:url(${pageContext.request.contextPath}/static/images/icon-login.png) no-repeat 0 -43px;position:absolute;right:-10px;cursor:pointer;}
        .login-main .login-bottom .center .item .icon-5 {background:url(${pageContext.request.contextPath}/static/images/icon-login.png) no-repeat -55px -43px;}
        .login-main .login-bottom .center .item .icon-6 {background:url(${pageContext.request.contextPath}/static/images/icon-login.png) no-repeat 0 -93px;position:absolute;right:-10px;margin-top:8px;cursor:pointer;}
        ...
        .login-main .login-bottom .tip .icon-check {margin:0 7px 0 0;width:14px;height:14px;border:none;background:url(${pageContext.request.contextPath}/static/images/icon-login.png) no-repeat -111px -48px;}
        ...
        body {background:url(${pageContext.request.contextPath}/static/images/loginbg.png) 0% 0% / cover no-repeat;position:static;font-size:12px;}
...
<div class="footer">
    ©版权所有 2022-2099 Original工作室<span class="padding-5">|</span><a target="_blank" href="http://www.miitbeian.gov.cn">湘ICP备16006642号-2</a>
</div>
