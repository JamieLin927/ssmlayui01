...
<head>
    <meta charset="utf-8">
    <title>Original-CRM - 基于Layui的后台管理系统前端模板</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/layuimini.css?v=2.0.4.2" media="all">
        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;"> <img src="${pageContext.request.contextPath}/static/images/favicon.ico" class="layui-nav-img" id="icon" name="icon">${sessionScope.userName.trueName}</a>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        var options = {
            iniUrl: "${pageContext.request.contextPath}/initmenu",    // 初始化接口
            clearUrl: "${pageContext.request.contextPath}/static/api/clear.json", // 缓存清理接口
